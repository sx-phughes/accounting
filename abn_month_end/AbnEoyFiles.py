...
def AbnEoyFile(year: int):
    last_of_year = last_biz_day(year, 12).strftime('%Y%m%d')

    dir = f'C:/gdrive/Shared drives/Clearing Archive/ABN_Archive/{last_of_year}'
    ...
    file_grabber = AbnFileGrabber(year, 12)
