...
def run_month_end_files(year: int, month: int, debug=False) -> None:
    ...
    fn = [
        ...
        [Positions.get_positions_data, "Getting positions data"],
        [Positions.get_positions_pivot, "Pivoting positions data"],
        [Positions.get_category_summary, "Summarizing positions data"],
