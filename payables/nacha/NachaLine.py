class NachaLine:
    def __init__(self, **fields: list):
        ...
        for i in fields.keys():
            self.line_string += self.construct_field(
...
class TransactionLine(NachaLine):
    def __init__(self, **fields):
        ...
        super().__init__(
            ...
            trace_no=[
                15,
                str(fields["rec_aba"])[0:8] + fields["entry_seq_no"],
            ],
        )
...
class AddendaLine(NachaLine):
    ...
    def check_company(self, vendor, payment_info):
        ...
        elif vendor == "Barclays Capital":
            payment_info = "FBO Account: 0120287610 - invoice " + payment_info
