"""Fields for use in constructing a wire payment that will make use of an
existing template in JPM Access.
"""
...
vd_fields = [["Value Date", 8]]  # YYYYMMDD
